...
//    public function finish($task_data){}
    ...
    class Process {
         ...
         */
        function __construct(callable $callback, bool $redirect_stdin_stdout = false, bool $create_pipe = true)
        {
        }
...
namespace Swoole\WebSocket {
    class Server extends \Swoole\Http\Server
    {
         ...
         * @param bool $finish
         */
        function push(int $fd, string $data, bool $binary_data = false, bool $finish = true)
        {
        }
